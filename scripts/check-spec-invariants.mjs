...
const invariants = [
  ...
  { id: "REG_UNKNOWN_TYPE_REJECT", re: /Any other unknown or future `covenant_type` MUST be rejected as `TX_ERR_COVENANT_TYPE_INVALID`\./, desc: "registry: unknown covenant_type rejected as TX_ERR_COVENANT_TYPE_INVALID" },
