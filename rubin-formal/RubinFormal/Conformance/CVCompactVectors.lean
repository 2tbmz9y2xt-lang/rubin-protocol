...
def cvCompactVectors_CV_COMPACT : List CVCompactVector := [
  {
    ...
    op := "compact_shortid",
    expectOk := true,
    wtxid := some (#[0x26, 0xce, 0x78, 0xc5, 0x67, 0x1f, 0x12, 0x91, 0x1e, 0x36, 0x10, 0x83, 0x10, 0x95, 0x30, 0x5e, 0xd0, 0x0a, 0x11, 0x2b, 0x9b, 0xa5, 0x9c, 0xdd, 0xb8, 0x7c, 0x69, 0x4b, 0xb8, 0xb4, 0xe6, 0x95]),
    nonce1 := some 506097522914230528,
    nonce2 := some 1084818905618843912,
    expectShortId := some (#[0xb5, 0x0c, 0x6f, 0xb8, 0x6b, 0x2f])
  },
  {
    id := "CV-C-02",
  ...
  },
  {
    ...
    op := "parse_tx",
    expectOk := true,
    tx := some (#[0x01, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]),
    expectTxid := some (#[0x76, 0xf1, 0x3a, 0xd1, 0xaf, 0xe0, 0xe8, 0xef, 0x7c, 0x8b, 0xc2, 0xcc, 0x9c, 0x25, 0x03, 0x7f, 0xfd, 0xfc, 0x44, 0xb1, 0xde, 0xb8, 0xc5, 0x18, 0x12, 0x2f, 0x16, 0xbb, 0xa9, 0xf8, 0x4a, 0x54]),
    expectWtxid := some (#[0x26, 0xce, 0x78, 0xc5, 0x67, 0x1f, 0x12, 0x91, 0x1e, 0x36, 0x10, 0x83, 0x10, 0x95, 0x30, 0x5e, 0xd0, 0x0a, 0x11, 0x2b, 0x9b, 0xa5, 0x9c, 0xdd, 0xb8, 0x7c, 0x69, 0x4b, 0xb8, 0xb4, 0xe6, 0x95])
  },
  {
    id := "CV-C-04",
    op := "parse_tx",
    expectOk := true,
    tx := some (#[0x01, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]),
    expectTxid := some (#[0xab, 0xf5, 0xba, 0x68, 0x5f, 0x88, 0x99, 0x8e, 0xf3, 0x36, 0xe4, 0xba, 0xf0, 0xbd, 0xd9, 0x02, 0xac, 0x4c, 0x9a, 0x5f, 0x30, 0x36, 0x93, 0x3a, 0xd9, 0x1e, 0x67, 0xe2, 0xa1, 0x17, 0x4d, 0x87]),
    expectWtxid := some (#[0x79, 0xb8, 0xa4, 0x99, 0xbc, 0xf2, 0x24, 0x29, 0xf1, 0xde, 0xac, 0x90, 0x38, 0x08, 0x12, 0xd5, 0x6b, 0x2d, 0x81, 0x62, 0x1e, 0x34, 0xc1, 0xd2, 0x00, 0xab, 0xa6, 0x1d, 0x5a, 0x37, 0x5e, 0x80])
  },
  {
    id := "CV-C-05",
