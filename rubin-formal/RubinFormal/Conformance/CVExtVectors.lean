...
-- Full Lean replay requires Q-FORMAL-CORE-EXT-01 (gen_lean_conformance_vectors.py ext ops support).
-- This stub satisfies the formal coverage gate (CVExtVectors.lean must exist).
