...
def checkCanonicalInvariantVector (v : CVCanonicalInvariantVector) : Bool :=
...
def allCVCanonicalInvariant : Bool :=
  cvCanonicalInvariantVectors.all checkCanonicalInvariantVector

theorem cv_canonical_invariant_vectors_pass : allCVCanonicalInvariant = true := by
  native_decide
