...
## Out-of-tree артефакты (informational)

- Формальная верификация (Lean4 proof pack) **не вендорится в этом репозитории** и не входит в baseline audit-pack.
  Любые упоминания формальных доказательств в спеках — informational-only, если отдельный proof-pack не предоставлен аудитору явно.
