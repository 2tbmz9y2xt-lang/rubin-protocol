...
use crate::constants::{
    CORE_EXT_WITNESS_SLOTS, COV_TYPE_EXT, COV_TYPE_HTLC, COV_TYPE_MULTISIG, COV_TYPE_P2PK,
    COV_TYPE_VAULT, MAX_MULTISIG_KEYS, MAX_VAULT_KEYS, MAX_VAULT_WHITELIST_ENTRIES,
};
...
pub fn witness_slots(covenant_type: u16, covenant_data: &[u8]) -> Result<usize, TxError> {
    match covenant_type {
        ...
        COV_TYPE_HTLC => Ok(2),
        COV_TYPE_EXT => Ok(CORE_EXT_WITNESS_SLOTS),
        _ => Err(TxError::new(
            ErrorCode::TxErrCovenantTypeInvalid,
