...
func TestSyncEngineLocalTipHeight(t *testing.T) {
	...
	require(t, (*SyncEngine)(nil).LocalTipHeight() == 0 && engine.LocalTipHeight() == 0, "nil engine=%d no-tip engine=%d, want 0 and 0", (*SyncEngine)(nil).LocalTipHeight(), engine.LocalTipHeight())
