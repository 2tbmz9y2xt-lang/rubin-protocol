...
class TestRelevanceTests(unittest.TestCase):
    ...
    def test_workflow_keeps_json_unconditional_and_gates_other_steps(self):
        ...
        trusted = gate + " && github.repository == '2tbmz9y2xt-lang/rubin-protocol' && (github.event_name == 'push' || (github.event_name == 'pull_request' && github.event.pull_request.head.repo.full_name == github.repository && github.event.pull_request.user.login == '2tbmz9y2xt-lang' && github.actor == '2tbmz9y2xt-lang'))"
