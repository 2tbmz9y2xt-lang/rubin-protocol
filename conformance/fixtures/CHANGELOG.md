...
Reason/tools/fixtures/non-goals: pin shared Unix UTF-8 lexical operator-path normalization for Go and Rust `rubin-node`. Manually authored; no generator. Changed fixture: `protocol/operator_path_normalization_v1.json`. Non-goals: no production behavior or storage/consensus change; no runner, CI, or generated artifact; no Windows or non-UTF-8 expansion.
